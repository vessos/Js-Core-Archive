...
describe("createCalculator()",function (){
    ...
    it('should return -5 after {subtract:3;subtract2}',function(){
        calc.subtract(3);calc.subtract(2);let value = calc.get();
        expect(value).to.be.equal(-5)
    });
    it('should return 4.2 after {add:5.3;subtract1.1}',function(){
        calc.add(5.3);calc.subtract(1.1);let value = calc.get();
        expect(value).to.be.equal(4.2)
    });
    it('should return 2 after {add:10;subtract7;add-2}',function(){
